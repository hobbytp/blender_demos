...
assert EDITION in ('dark', 'editorial', 'flow', 'lesson', 'ha', 'ha-lesson', 'migration', 'migration-lesson', 'pmxcfs', 'pmxcfs-lesson', 'durability', 'durability-lesson', 'virtqueue', 'virtqueue-lesson')
